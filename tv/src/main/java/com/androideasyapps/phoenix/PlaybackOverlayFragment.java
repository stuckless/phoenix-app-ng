...
public class PlaybackOverlayFragment extends android.support.v17.leanback.app.PlaybackOverlayFragment {
    ...
    public interface OnPlayPauseClickedListener {
        public void onFragmentPlayPause(MediaFile movie, int position, Boolean playPause);
        public void onSeek(int skip);
    }
...
//
        ...
        playbackControlsRowPresenter.setOnActionClickedListener(new OnActionClickedListener() {
            public void onActionClicked(Action action) {
                if (action.getId() == mPlayPauseAction.getId()) {
                    ...
                    mCallback.onSeek(mPlaybackControlsRow.getCurrentTime()+30000);
                    ...
                    mCallback.onSeek(mPlaybackControlsRow.getCurrentTime()-10000);
                }
    ...
    private int getDuration() {
        MediaFile movie = mSelectedMovie;
        MediaMetadataRetriever mmr = new MediaMetadataRetriever();

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            mmr.setDataSource(MediaUtil.getVideoURL(AppInstance.getInstance(this.getActivity()).getServer(), movie), new HashMap<String, String>());
        } else {
            mmr.setDataSource(MediaUtil.getVideoURL(AppInstance.getInstance(this.getActivity()).getServer(), movie));
        }
...
//            MediaFile item = (MediaFile) mPlaybackControlsRow.getItem();
...
//            updateVideoImage(.getCardImageURI());
//        }
...
//        updatePlaybackRow(mCurrentItem);
    ...
    static class DescriptionPresenter extends AbstractDetailsDescriptionPresenter {
        ...
        protected void onBindDescription(ViewHolder viewHolder, Object item) {
            viewHolder.getTitle().setText(((MediaFile) item).getTitle());
            viewHolder.getSubtitle().setText(((MediaFile) item).getGenre());
        }
    }
