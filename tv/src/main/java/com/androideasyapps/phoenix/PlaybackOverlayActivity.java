...
public class PlaybackOverlayActivity extends Activity implements PlaybackOverlayFragment.OnPlayPauseClickedListener {
    ...
    public void onFragmentPlayPause(MediaFile movie, int position, Boolean playPause) {
        ...
        AppInstance.getInstance(this).getRequestInterceptor().addAuthHeader(headers);
        System.out.println("VIDEO: " + MediaUtil.getVideoURL(AppInstance.getInstance(this).getServer(), movie));
        mVideoView.setVideoURI(Uri.parse(MediaUtil.getVideoURL(AppInstance.getInstance(this).getServer(), movie)), headers);
